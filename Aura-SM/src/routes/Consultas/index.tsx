                        ...
                        consultas.map((consulta) => (
                            <div key={consulta.id} className="p-4 border rounded-lg">
                                ...
                                <div className="mt-3 flex space-x-2">
                                    <Link to={`/editar/consulta/${consulta.id}`} className="bg-blue-600 text-white px-3 py-1 rounded text-sm hover:bg-blue-700 transition">
                                        <Editar className="inline-block mr-1" />
                                        Editar
                                    </Link>
